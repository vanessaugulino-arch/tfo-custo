...
export const MODELO_INSUMOS: ModeloImport = {
  ...
  campos: [
    ...
    { id: "unidade_compra", label: "Unidade de compra", tipo: "texto", obrigatorio: false, keywords: ["unidade", "medida"], explicacao: "metro, peso_kg, rolo ou peca. Se ausente, assume metro." },
    { id: "fator_metros_por_unidade", label: "Metros por unidade", tipo: "numerico", obrigatorio: false, keywords: ["rendimento", "metros por", "fator"], explicacao: "Quantos metros lineares equivalem a 1 kg ou a 1 rolo. Obrigatório apenas para peso_kg ou rolo — peça não usa este campo." },
